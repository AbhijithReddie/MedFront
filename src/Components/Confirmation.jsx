                ...
                <Col md={8}>
                    <div className="bg-light p-4 rounded shadow-lg">
                        ...
                        <div className="mb-4">
                                        ...
                                        />
                                            ...
                                            <Card.Body>
                                                ...
                                                <Card.Text>
                                                    ...
                                                    <p><strong>Price Per Quantity:</strong> ₹{item.pricePerUnit.toFixed(2)}</p>
                            ...
                            <p className="mt-3"><strong>GST:</strong> {getGST(totalPrice).toFixed(2)}</p>
                            ...
                            <div className="d-flex justify-content-center mt-4">
                                <Button variant="success" className="mx-2" onClick={() => navigate('/cart')} style={{'width':'200  px'}}>
